...
public class MainMenu{
	...
	private static final int MAX_SHIP_SIZE = 3;
	private static final int MAX_SHIP_COUNT = 4;
	
	public MainMenu(JFrame theWindow){
		window = theWindow;
		backgroundImageIcon = new ImageIcon("cattleshipTitle.png");
	...
	public void loadTitleScreen(){
		bkgImageContainer.setSize(900, 615);
